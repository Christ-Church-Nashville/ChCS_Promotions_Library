...
announcements_insertWeeks
announcements_masterToArchive

*/

function announcements_setupAutomation_master(){//used by Announcements Master
  if( ! announcements_isAuthorizedToRun()){
...
function announcements_isAuthorizedToRun(){
